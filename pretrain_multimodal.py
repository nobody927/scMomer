...
parser.add_argument("--data_path", type=str, default="/home/lyh/project/sc/main/model/data/preprocessed_data.h5mu", help='Path of data.')
...
parser.add_argument("--rna_model_path", type=str, default='/home/lyh/project/sc/main/model/saved_model/panglao_pretrain.pth')
parser.add_argument("--atac_model_path", type=str, default='/home/lyh/project/sc/main/model/saved_model/atac_model.pth')
parser.add_argument("--ckpt_path", type=str, default='/home/lyh/project/sc/main/model/saved_model/multimodal.pth')
parser.add_argument("--model_name", type=str, default='pretained_model')
    ...
    for index, data in enumerate(ProgressBar, 0):
        ...
        if index % GRADIENT_ACCUMULATION != 0:
            with model.no_sync():
                ...
                discrim_loss = discrim_loss_fn(labels, logits)
