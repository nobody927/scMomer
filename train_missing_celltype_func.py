...
parser.add_argument("--pretrained_model_path", type=str, default='/home/lyh/project/sc/main/model/saved_model/missing_30_best.pth')
...
parser.add_argument("--model", type=str, default='scMomer')
...
def test(args, model, test_loader, fold, name):
    ...
    with torch.no_grad():
        ...
        if is_master:
            ...
            # with open('/home/lyh/project/data/label/' +args.model+ '_' + name + '_' + str(fold) + '_prediction', 'wb') as fp:
            #     pkl.dump(predictions, fp)
            # with open('/home/lyh/project/data/label/' +args.model+ '_' + name + '_' + str(fold) + '_label', 'wb') as fp:
            #     pkl.dump(truths, fp)
