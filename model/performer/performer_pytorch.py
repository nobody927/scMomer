...
from model.performer.reversible import ReversibleSequence, SequentialSequence
...
class Gene2VecPositionalEmbedding(nn.Module):
    def __init__(self, dim, max_seq_len):
        super().__init__()
        gene2vec_weight = np.load('/home/lyh/project/sc/main/model/data/gene2vec_16906.npy')
...
class Performer(nn.Module):
    def __init__(
        ...
        nb_features = None,                 # number of random features, if not set, will default to (d * log(d)), where d is the dimension of each head
