...
class RelationClassifier(nn.Module):
    def __init__(self, input_dim, hidden_dim1, hidden_dim2):
        ...
        self.fc1 = nn.Linear(input_dim, hidden_dim1)  # 第一层全连接层
        self.fc2 = nn.Linear(hidden_dim1, hidden_dim2)   # 第二层全连接层
        self.fc3 = nn.Linear(hidden_dim2, 1)     # 输出层，输出一个概率值
    ...
    def forward(self, input):
        ...
        x = torch.sigmoid(self.fc3(x))  # 使用 sigmoid 激活函数进行二分类
        return x