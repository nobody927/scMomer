...
# parser.add_argument("--data_path", type=str, default='/home/lyh/project/sc/main/model/data/preprocessed_fetal_new.h5mu', help='Path of data for pretraining.')
parser.add_argument("--data_path", type=str, default="/home/lyh/project/data/5fold/train_atac_fold2_preprocessed_data.h5mu", help='Path of data for pretraining.')
...
parser.add_argument("--model_name", type=str, default='atac_model', help='Pretrained model name.')
